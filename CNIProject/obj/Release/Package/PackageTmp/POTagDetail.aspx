<%@ Page Title="PO Receiving Detail" Language="vb" AutoEventWireup="false" MasterPageFile="~/SRN.Master" CodeBehind="POTagDetail.aspx.vb" Inherits="CNIProjet.POTagDetail" %>
        ...
        <div class="col-lg-12">
            <div class="card border-primary">
                <div class="card-header py-12">
                    <div class="row">
                        <div class="col-md-10">
                            <h6 class="m-0"><a href="Menu.aspx">Menu</a><span class="mx-2 mb-0">/</span><asp:LinkButton ID="LinkButton1" runat="server">PO Receiving</asp:LinkButton><span class="mx-2 mb-0">/</span><strong class="text-black"><%: Page.Title %></strong>  </h6>
                        </div>
                             ...
                             <div class="col-sm-12 mt-2">
                                 <div class="card">                                     
                                     ...
                                     <h6 class="card-title text-primary">
                                         <asp:Label ID="lbltagID" runat="server" Font-Bold="False" Text='<%#Eval("TagID")%>'></asp:Label>
                                     </h6>
                                     <span style="font-size:13px;">Item : <%#Eval("Item")%></span><br>
                                     <span style="font-size:13px;">Description : <%#Eval("Description")%></span><br>
                                     <span style="font-size:13px;">Tag Qty : <asp:Label ID="lblQtyTag" runat="server" Font-Bold="False" Text='<%#Eval("TagQty")%>'></asp:Label></span><br>
                                     <span style="font-size:13px;">Tag Qty Convert : <asp:Label ID="lblQtyTagConv" runat="server" Font-Bold="False" Text='<%#Eval("TagQtyConv")%>'></asp:Label></span><br>
