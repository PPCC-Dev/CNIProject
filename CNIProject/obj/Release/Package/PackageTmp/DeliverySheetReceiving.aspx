<%@ Page Title="Delivery Sheet Receiving" Language="vb" AutoEventWireup="false" MasterPageFile="~/SRN.Master" CodeBehind="DeliverySheetReceiving.aspx.vb" Inherits="CNIProjet.DeliverySheetReceiving" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function ShowSweetAlert2(type, msg, icon) {
            Swal.fire(
                type,
                msg,
                icon
                        ...
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" class="card card-body mb-3" style="max-width: 100%; font-size:13px;" runat="server">
                                ...
                                <div class="row">                        
                                    ...
                                    <div class="col-sm-9">
                                        <asp:Label ID="lblListItemDesc" runat="server" Text='<%#Eval("ItemDescription")%>'></asp:Label>
                                ...
                                <div class="row"> 
                                    <div class="col-sm-6">
                                            <strong>Qty Order: </strong> <asp:Label ID="lblListQtyOrder" runat="server" Text='<%#Eval("qty_order")%>'></asp:Label> 
                                            <%--<asp:Label ID="lblListPoUM" runat="server" Text='<%#Eval("PoUM")%>'></asp:Label>--%>
                                    </div>
                                    <div class="col-sm-6">
                                            <strong>Qty Received: </strong> <asp:Label ID="lblListQtyReceived" runat="server" Text='<%#Eval("Qty_Received")%>'></asp:Label>
                                    </div>
                                </div>

                                <div class="row">                        
                                    <div class="col-sm-6">
                                        <strong>Qty Remain: </strong> <asp:Label ID="lblListRemain" runat="server" Text='<%#Eval("Qty_Remain")%>'></asp:Label>
                                    </div>
                                    <div class="col-sm-6">
                                        <strong>Receive Qty: </strong> <asp:Label ID="lblListSumQty" runat="server" Text='<%#Eval("sum_qty")%>'></asp:Label>
                                    </div>
                                </div>
                               ...
                               <%-- <div class="row">                        
                                    <div class="col-sm-6">
                                        <p class="text-primary"><strong>Material Cost: </strong> --%>
                                            <%--<asp:Label ID="lblListMatlCost" runat="server" Text='<%#Eval("UnitMatCostConv")%>'></asp:Label></p>--%>
                                    <%--</div>--%>
                                    <%--<div class="col-sm-6">--%>
                                        <%--<p class="text-primary"><strong>Line Amt: </strong>
                                            <%--<asp:Label ID="lblListLineAmt" runat="server" Text='<%#Eval("LineAmt")%>'></asp:Label></p>--%>
                                    <%--</div>--%>
                                <%--</div>--%>
