...
Public Class DSTagDetail
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        ...
        Response.Redirect("DeliverySheetReceiving.aspx" & PostURL)
    ...
    Protected Sub PanelList_RowDataBound(sender As Object, e As ListViewItemEventArgs) Handles PanelList.ItemDataBound
        ...
        If e.Item.ItemType = ListViewItemType.DataItem Then
            ...
            lblQtyTag.Text = FormatNumber(lblQtyTag.Text)
            lblQtyTagConv.Text = FormatNumber(lblQtyTagConv.Text)
    ...
    Sub BindListDetail()
        ...
        PropertyList = "tag_id, item, description, lot, tag_qty, tag_qty_conv, po_num, po_line, po_release"

        ds = oWS.LoadDataSet(Session("Token").ToString, "ppcc_ex_ds_receive_details", PropertyList, Filter, "po_num, po_line, po_release", "", 0)

        'If ds.Tables(0).Rows.Count > 0 Then

        If ds.Tables(0).Rows.Count > 0 Then
            'AmtTotalFormat.Value = ds.Tables(0).Rows(0)("tag_qty").ToString
        End If
