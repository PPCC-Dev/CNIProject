<%@ Page Title="Cycle Count Detail" Language="vb" AutoEventWireup="false" MasterPageFile="~/SRN.Master" CodeBehind="CycleCountDetail.aspx.vb" Inherits="CNIProjet.CycleCountDetail" %>
                            ...
                            <ItemTemplate>
                                <div class="col-sm-12 mt-2">
                                    <div class="card">
                                        ...
                                        <h6 class="card-title text-primary"><asp:Label ID="lbltagid" runat="server" Font-Bold="False" Text='<%#Eval("tag_id")%>'></asp:Label>
                                            <asp:LinkButton ID="btndelete" CssClass="btn text-danger btn-sm float-right" CommandName="deletetag" runat="server"><i class="fas fa-trash-alt"></i></asp:LinkButton>
                                        </h6>
                                        ...
                                        <span style="font-size:13px;">Old Tag Qty : <asp:Label ID="lblQtyTag" runat="server" Font-Bold="False" Text='<%#Eval("TagQty")%>'></asp:Label></span><br />
                                        <span style="font-size:13px;">Count Qty : <asp:Label ID="lblQty" runat="server" Font-Bold="False" Text='<%#Eval("count_qty")%>'></asp:Label></span><br />
<%--                                        <span style="font-size:13px;">Status : <strong><asp:Label ID="lblstatus" runat="server" Font-Bold="False" Text='<%#Eval("stat")%>'></asp:Label></strong></span><br>--%>
