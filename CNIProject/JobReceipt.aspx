<%@ Page Title="Job Receipt" Language="vb" AutoEventWireup="false" MasterPageFile="~/SRN.Master" CodeBehind="JobReceipt.aspx.vb" Inherits="CNIProjet.JobReceipt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#<%=chkfraction.ClientID%>").change(function () {
            ...
            <div class="card border-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 float-right">
                            <asp:Button ID="btndetail" runat="server" class="btn btn-info btn-sm float-right mx-2 mb-0"  Text="Detail" UseSubmitBehavior="false" />
                            <asp:Button ID="btnreset" runat="server" class="btn btn-warning btn-sm float-right mx-2 mb-0"  Text="Reset" UseSubmitBehavior="false" />
                    ...
                    <table  width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-sm-4 width-div">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkfraction" class="form-check-input txt-margin" runat="server" Checked="false" /> <span>งานเศษ</span>
                                </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-sm-2 width-div">
                                    <asp:DropDownList ID="ddlloc" runat="server" class="form-control form-control-sm txt-margin"></asp:DropDownList>
                                </div>
                                </div>
                            </td>
                        </tr>
                                            ...
                                            <asp:Panel ID="Panel1" class="card card-body mb-3" style="max-width: 100%;" runat="server">
                                                ...
                                                <div class="row" style="display:none;">
                                                    ...
                                                    <div class="col-sm-4 float-right">
                                                         <asp:CheckBox ID="chkLabelControl" class="form-check-input float-right mx-2 mb-0" runat="server" Enabled="false" checked='<%# Eval("LabelItemControl") %>' /> <spen>Label Item Control</spen>
                                                    </div>                          
                                                </div>
                                                ...
                                                <div class="row">                        
                                                    <div class="col-sm-12">
                                                        ...
                                                        &nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text='<%#Eval("ItemDescription")%>'></asp:Label>
                                                    </div>  
